import{d as No,r as Lr,a as mt,o as Ne,c as ko,w as Ct,b as pt,e as Vn,f as fc,_ as pc,g as Ur,h as mc,i as gc,F as ws,j as _c,t as yc}from"./index-d34d406e.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Df{constructor(){this.Ki=!1}initialize(t,n){this.$i=t,this.indexManager=n,this.Ki=!0}getDocumentsMatchingQuery(t,n,r,i){return this.Ui(t,n).next(s=>s||this.Wi(t,n,i,r)).next(s=>s||this.Gi(t,n))}Ui(t,n){if(io(n))return m.resolve(null);let r=Pt(n);return this.indexManager.getIndexType(t,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=ci(n,null,"F"),r=Pt(n)),this.indexManager.getDocumentsMatchingTarget(t,r).next(s=>{const o=S(...s);return this.$i.getDocuments(t,o).next(a=>this.indexManager.getMinOffset(t,r).next(u=>{const c=this.zi(n,a);return this.ji(n,c,o,u.readTime)?this.Ui(t,ci(n,null,"F")):this.Hi(t,c,n,u)}))})))}Wi(t,n,r,i){return io(n)||i.isEqual(A.min())?this.Gi(t,n):this.$i.getDocuments(t,r).next(s=>{const o=this.zi(n,s);return this.ji(n,o,r,i)?this.Gi(t,n):(Ws()<=D.DEBUG&&y("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),li(n)),this.Hi(t,o,n,ud(i,-1)))})}zi(t,n){let r=new nt(au(t));return n.forEach((i,s)=>{fr(t,s)&&(r=r.add(s))}),r}ji(t,n,r,i){if(t.limit===null)return!1;if(r.size!==n.size)return!0;const s=t.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Gi(t,n){return Ws()<=D.DEBUG&&y("QueryEngine","Using full collection scan to execute query:",li(n)),this.$i.getDocumentsMatchingQuery(t,n,xt.min())}Hi(t,n,r,i){return this.$i.getDocumentsMatchingQuery(t,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
